...
<head>
	...
	<title>Domain Enrollments</title>
		...
		<div class="container-fluid">
			...
			<section>
				...
				<div class="view gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
					...
					<a href="" class="white-text mx-3">List of Domains</a>
						...
						<table class="table table-hover mb-0">
							...
							<thead>
								<tr>
									...
									<th class="th-lg">Id<i class="fa fa-sort ml-1"></i></th>
									<th class="th-lg">Name<i class="fa fa-sort ml-1"></i></th>
									<th class="th-lg">Label<i class="fa fa-sort ml-1"></i></th>
									<th class="th-lg">Date Format<i class="fa fa-sort ml-1"></i></th>
									<th class="th-lg">Date time format<i class="fa fa-sort ml-1"></i></th>
									<th class="th-lg">Locale<i class="fa fa-sort ml-1"></i></th>
							...
							<tbody>
								<c:forEach items="${domains}" var="domain">
									<tr>
										<th scope="row">
											<input type="checkbox" id="domaincheckbox${domain.id}">
											<label for="domaincheckbox${domain.id}" class="label-table"></label>
										</th>
										<td>${domain.id}</td>
										<td>${domain.name}</td>
										<td>${domain.label}</td>
										<td>${domain.dateFormat}</td>
										<td>${domain.dateTimeFormat}</td>
										<td>${domain.locale}</td>
										<td>
											<a href="<c:url value='/domain/edit-${domain.id}-domain' />">Edit</a>&nbsp;&nbsp;
											<a href="<c:url value='/domain/delete-${domain.id}-domain' />">Delete</a>
										</td>
									</tr>
								</c:forEach>
			...
			<section class="mb-5 pb-4">
				<a href="<c:url value='/domain/new' />" class="btn btn-primary waves-effect waves-light">Add new</a>
			</section>	
		</div>
	</main> 
