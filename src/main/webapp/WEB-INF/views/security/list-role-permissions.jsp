		...
		<div class="container-fluid">
			...
			<section>
				...
				<div class="view gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
					...
					<a href="" class="white-text mx-3">Role Permissions: List</a>
					<div>
				...
				<div class="px-4">
					...
					<div class="table-responsive">
						...
						<table class="table table-hover mb-0">
							...
							<!--Table body-->
							<tbody>
								<c:forEach items="${entities}" var="rolePermission">
									<tr>
										<th scope="row">
											<input type="checkbox" id="domaincheckbox${rolePermission.id}">
											<label for="domaincheckbox${rolePermission.id}" class="label-table"></label>
										</th>
										<td>${rolePermission.name}</td>
										<td>
											<a href="<c:url value='/role-permissions/${rolePermission.id}/edit' />">Edit</a>&nbsp;&nbsp;
											<a href="<c:url value='/role-permissions/${rolePermission.id}/delete' />">Delete</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
			...
			<section class="mb-5 pb-4">
				<a href="<c:url value='/role-permissions/new' />" class="btn btn-primary waves-effect waves-light">Add new</a>
			</section>	
		</div>
	</main> 
